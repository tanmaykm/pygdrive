...
class GDriveSync:
        ...
        for f, attrs in loc_flist.items():
            ...
            if attrs['is_dir']:
                ...
                if f not in gdrive_flist:
                    ...
                    # GDriveSync.LOGGER.debug("existing file tdiff: " + str(tdiff))
                    if tdiff >= 1:
                    ...
                    #else:
                    #    GDriveSync.LOGGER.debug("already in sync " + attrs['fullpath'])
    ...
    def _download(locpath, remid):
        # GDriveSync.LOGGER.debug("downloading " + locpath + " from " + remid)
    ...
    def _sync_file_time(locpath, gdrive_file):
        ...
        # GDriveSync.LOGGER.debug("setting file time to " + str(mtime) + " timestamp: " + str(timestamp))
    ...
    def init_creds(credsb64):
        ...
        GDriveSync.USER_ID = creds.id_token['email']
        GDriveSync.AUTH_TOK = creds.access_token
